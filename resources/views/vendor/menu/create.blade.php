...
<div class="p-6">
    <div class="flex items-center mb-6">
        <a href="{{ route('vendor.menu') }}" class="text-gray-600 hover:text-gray-800 mr-4">
            ← Back to Menu
        </a>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" 
                              ...
                              placeholder="Brief description of the dish" required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @error('image')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-500 mt-1">Upload JPG, PNG, GIF (max 2MB)</p>
                </div>
            </div>

            <div class="flex justify-end space-x-4 mt-8">
                <a href="{{ route('vendor.menu') }}" class="px-4 py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-50">
                    Cancel
                </a>
