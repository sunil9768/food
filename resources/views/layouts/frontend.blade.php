            ...
            <div class="flex items-center space-x-4">
                @auth
                    ...
                    @if(Auth::user()->hasRole('user'))
                        <a href="{{ route('user.dashboard') }}" class="text-gray-700 hover:text-curry">My Account</a>
                    @endif
                ...
                @else
                    <a href="{{ route('login') }}" class="text-gray-700 hover:text-curry">Login</a>
                    <a href="{{ route('register') }}" class="bg-curry text-white px-4 py-2 rounded hover:bg-orange-600">Register</a>
                @endauth
            </div>
        </div>
    </header>
