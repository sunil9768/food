...
<div class="p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2 border-b">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $item->menuItem->vendor->restaurant_name ?? $item->menuItem->vendor->name }}</p>
    ...
    <div class="mt-8 pt-6 border-t flex justify-between">
        <a href="{{ route('admin.orders') }}" class="text-primary hover:text-orange-600 font-semibold">
            ← Back to Orders
        </a>
        <a href="{{ route('admin.order.invoice', $order->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
            View Invoice
        </a>
    </div>
</div>
