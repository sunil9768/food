...
<body>
    <div class="print-btn">
        ...
        <a href="{{ route('admin.orders') }}" style="margin-left: 10px; color: #f97316; text-decoration: none;">← Back to Orders</a>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->menuItem->vendor->restaurant_name ?? $item->menuItem->vendor->name }}</td>
                <td>{{ $item->quantity }}</td>
